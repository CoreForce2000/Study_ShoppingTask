...
const CheckboxTable: React.FC<CheckboxTableProps> = ({ initialOptions, exclusiveOptions = [], allowMultiple, onChange }) => {
    ...
    return (
        <div className={styles.checkboxTableContainer} style={{ fontSize: fontSizeParent }}>
