...
import { selectAge, selectGender, selectGroup, selectHandedness, selectOnlineShoppingFrequency, selectParticipantId } from '../../../../store/surveySlice';
...
const CsvExportButton: React.FC = () => {
  ...
  const handleExportCsv = () => {
    ...
    const csvContent = "data:text/csv;charset=utf-8," + demographicsRow.join(',') + '\n' + '\n' +
      shopHeaderRow + '\n' +
  ...
  return (
    <button onClick={handleExportCsv} className={styles.exportButton}>Export to CSV</button>
  );
};
